...
class RelativisticObjectIntersectionTest {
    ...
    fun relativisticDopplerBeamingProducesApproachingBlueshiftAndRecedingRedshift() {
        ...
        // At T = 0, object is on +X axis moving in +Y direction (v_Y > 0)
        val objPos = worldline.positionAt(0.0)

        // 1. Photon moving toward observer along +Y (approaching object emitter):
        ...
        // 2. Photon moving away from observer along -Y (receding object emitter):
        ...
        // Approaching Doppler shift must exceed receding Doppler shift
