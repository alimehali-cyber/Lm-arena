    ...
    fun getAsterisms(): List<CelestialObject> {
        return listOf(
            CelestialObject(
                ...
                nameFa = "صورتواره ملاقه بزرگ / هفت‌اورنگ",
                raDeg = 180.0,
                decDeg = 55.0,
                magnitude = 1.8,
            ...
            CelestialObject(
                ...
                nameFa = "صورتواره مثلث تابستانی (ونوشا–ذنب–نسر طائر)",
                raDeg = 295.0,
                decDeg = 30.0,
                magnitude = 0.4,
            ...
            CelestialObject(
                ...
                nameFa = "صورتواره شش‌ضلعی زمستانی",
                raDeg = 90.0,
                decDeg = 15.0,
                magnitude = 0.1,
            ...
            CelestialObject(
                ...
                nameFa = "صورتواره چهارضلعی بزرگ اسب بالدار",
                raDeg = 345.0,
                decDeg = 20.0,
                magnitude = 2.4,
