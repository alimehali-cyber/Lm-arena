...
class AstroAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_RESCHEDULE_ALL = "com.example.ACTION_RESCHEDULE_ALL"
        const val ACTION_TRIGGER_ISS_NOTIFICATION = "com.example.ACTION_TRIGGER_ISS_NOTIFICATION"
        const val ACTION_TRIGGER_OBJECT_NOTIFICATION = "com.example.ACTION_TRIGGER_OBJECT_NOTIFICATION"
